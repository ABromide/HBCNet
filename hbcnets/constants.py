##################
DATA_PREPROCESSING = 0 ### For the first time you need to set `DATA_PREPROCESSING=1`
...
HONEST = AGE  # This is the target attribute (i.e., y) in the paper. Use this to set your desired attribute.
CURIOUS = RACE  # This is the sensitive attribute (i.e., s) in the paper. Use this to set your desired attribute.
